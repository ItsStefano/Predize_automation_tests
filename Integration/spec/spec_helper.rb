...
#Declarando pages do Mercado Livre
require_relative "support/view/pages/ML/dashML_page"
require_relative "support/view/pages/ML/loginML_page"
require_relative "support/view/pages/ML/productML_page"
...
$CONFIG = YAML.load_file(File.join(Dir.pwd, "spec/support/config/hmg.yml"))
